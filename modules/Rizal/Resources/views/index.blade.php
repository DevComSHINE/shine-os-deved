            ...
            <div class="col-md-12">
              <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <blockquote>
                    <p><strong>ShineOS+</strong> is dedicated to our Dr. Rizal who, in his self serving heroism, helped a many people in his practice of medicine as an Opthalmologist. <strong>ShineOS+</strong> is created to improve healthcare services in managing data and continuity of health services by making access to pertinent data fast and efficient.</p>
                    <p>This Rizal Module is a sample module to demonstrate the easy of creating new extensions for ShineOS+.</p>
                    </blockquote>
                </div><!-- /.box-body -->
