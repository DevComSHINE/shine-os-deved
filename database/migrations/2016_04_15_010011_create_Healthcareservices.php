...
class CreateHealthcareservices extends Migration {
    ...
    public function up() {
        Schema::create('healthcare_services', function (Blueprint $table) {
            ...
            $table->string('source_referrer_type', 60)->nullable();
            $table->string('source_referrer', 60)->nullable();
            $table->datetime('encounter_datetime');
            $table->string('seen_by',60)->nullable();
        ...
        Schema::create('disposition', function (Blueprint $table) {
            ...
            $table->string('discharge_condition', 60)->nullable();
            $table->datetime('discharge_datetime')->nullable();
            $table->binary('discharge_notes')->nullable();
    ...
    public function down() {
        ...
        Schema::drop('healthcare_addendum');
