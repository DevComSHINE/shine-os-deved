...
class CreateConsultationTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('general_consultation', function (Blueprint $table) {
            ...
            $table->string('medicalcategory_id', 60)->nullable();
            $table->binary('complaint')->nullable();
            $table->binary('complaint_history')->nullable();
            $table->binary('physical_examination')->nullable();
         ...
         Schema::create('vital_physical', function (Blueprint $table) {
            ...
            $table->string('temperature', 60)->nullable();
