...
class CreateLovTable extends Migration
{
    ...
    public function up()
    {
        ...
        {
            $table->increments('id');
            $table->string('disease_id',255);
            $table->string('disease_category',255);
            $table->string('disease_code', 60);
            $table->string('disease_name',255);
            $table->string('phie_name',60);
            $table->string('disease_input_type',255);
            $table->string('disease_radio_values',255);
            $table->char('sex_limit',1);
            $table->integer('min_age_limit');
            $table->integer('max_age_limit');
            $table->smallInteger('block_width');
            $table->integer('before_after');
        ...
        Schema::create('lov_medicalcategory', function (Blueprint $table) {
            ...
            $table->string('medicalcategory_group', 60);
