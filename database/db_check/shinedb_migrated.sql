...
CREATE TABLE IF NOT EXISTS `facilities` (
  ...
  `facility_logo` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
-- --------------------------------------------------------
--
-- Table structure for table `facility_geodata`
--
CREATE TABLE IF NOT EXISTS `facility_geodata` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `facility_geodata_id` varchar(60) COLLATE utf8_unicode_ci NOT NULL,
  `facility_id` varchar(60) COLLATE utf8_unicode_ci NOT NULL,
  `population` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `barangay` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `households` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bhs` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `households_water_1` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `households_water_2` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `households_water_3` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `households_toilet` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `households_solid_waste` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `households_sanitary` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `food_establishments` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `food_establishments_permit` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `food_handlers` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `food_handlers_permit` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `salt_samples` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `salt_samples_iodine` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
...
-- --------------------------------------------------------
--
-- Table structure for table `measles_record`
--
CREATE TABLE IF NOT EXISTS `measles_record` (
  `measles_id` varchar(32) NOT NULL,
  `healthcareservice_id` varchar(32) NOT NULL,
  `signs_rashes` enum('Y','N','U') DEFAULT 'U',
  `rash_onset` datetime DEFAULT NULL,
  `rash_duration` int(40) DEFAULT NULL,
  `generalized_rash` enum('Y','N','U') DEFAULT 'U',
  `origin_on_body` varchar(40) DEFAULT NULL,
  `direction_of_spread` varchar(40) DEFAULT NULL,
  `signs_fever` enum('Y','N','U') DEFAULT 'U',
  `temperature` int(10) DEFAULT NULL,
  `temperature_skin` enum('H','W','N') DEFAULT 'N',
  `cough` enum('Y','N','U') DEFAULT 'U',
  `runny_nose_coryza` enum('Y','N','U') DEFAULT 'U',
  `conjunctivitis` enum('Y','N','U') DEFAULT 'U',
  `kopliks_spots` enum('Y','N','U') DEFAULT 'U',
  `notes` text,
  `hospitalized` enum('Y','N','U') DEFAULT 'U',
  `days_hospitalized` int(10) DEFAULT NULL,
  `pneumonia` enum('Y','N','U') DEFAULT 'U',
  `encephalitis` enum('Y','N','U') DEFAULT 'U',
