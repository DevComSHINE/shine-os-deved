        ...
        <div class="info-box padding-1p">
          ...
          <div class="info-box-content">
            <div class="col-md-5">
              ...
              @if($healthcareData)
              <br />
                  <label class="control-label noPadding fixwidth150">Attending Physician:</label> <strong>{{ getUserFullNameByFacilityUserID($healthcareData->seen_by) }}</strong><br />
                  <label class="control-label noPadding fixwidth150">Facility:</label>  <strong>{{ getFacilityByFacilityUserID($healthcareData->seen_by, 'facility_name') }}</strong>
              @endif
              </p>
            </div>
            <div class="col-md-7">
              @if($healthcareData)
                  ...
                  @if($healthcareType=='FOLLO')
                      <p>
                          ...
                          <a href="{{ url('healthcareservices/qview/'.$patient->patient_id.'/'.$healthcareData->parent_service_id) }}" class="hidden bg-yellow text-black kbd floatleft" data-toggle="modal" data-target="#myInfoModal">View Previous Consultation | <i class="fa fa-search"></i></a><br />
                      </p>
                  @endif
                  <!-- end RJBS -->
