            ...
            <tbody>
                ...
                <tr style="background-color: #FFFFFF; border-radius: 9px;">
                    <td valign="top" colspan="2">
                        ...
                        <h4> <strong> Temporary Password: </strong> {{ $temporary_password }} </h4>
                         <br />

                        <hr />
<p>You requested that your password because your forgot. Click the link below to activate the temporary password above. Login to your account and provide a new password.</p>
