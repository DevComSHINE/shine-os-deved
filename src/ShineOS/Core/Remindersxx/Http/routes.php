...
Route::group(['prefix' => 'reminders', 'namespace' => 'ShineOS\Core\Reminders\Http\Controllers', 'middleware' => 'auth.access:reminders'], function()
{
     ...
     */
    Route::get('/add/{patiend_id}/{healthcareservice_id}', ['as' => 'reminders.add', 'uses' => 'RemindersController@createReminder']);
    /**
    ...
    Route::get('/testemail', ['uses' => 'RemindersController@testemail']);
...
Route::group(['prefix' => 'message', 'namespace' => 'ShineOS\Core\Reminders\Http\Controllers'], function()
{
    /**
     * Broadcasts listings
     */
    Route::get('/sendtoday', ['uses' => 'RemindersController@cronReminders']);
});
