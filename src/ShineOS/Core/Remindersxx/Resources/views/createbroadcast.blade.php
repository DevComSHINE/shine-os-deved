        ...
        <div class="box-body">
          {!! Form::open(array('url' => 'broadcast/add', 'method' => 'post','id' => 'defaultForm', 'class' => 'form-horizontal')) !!}
            ...
            <div class="box-content">
                <p class="innerbox">You can send Broadcast messages to your patients or to your users within your SHINE OS+ Administrative Facility. Choose to whom you want the broadcast to be send. Fill in the subject and your message and click send. Your message will be recieved by your recipients thru email or SMS. </p>
